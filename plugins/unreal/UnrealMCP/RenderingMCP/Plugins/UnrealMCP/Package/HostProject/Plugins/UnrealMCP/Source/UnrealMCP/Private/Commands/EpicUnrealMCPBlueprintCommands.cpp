...
TSharedPtr<FJsonObject> FEpicUnrealMCPBlueprintCommands::HandleGetMaterialGraph(const TSharedPtr<FJsonObject>& Params)
{
    ...
    // Get expressions based on asset type
    const TArray<UMaterialExpression*>* ExpressionsPtr = nullptr;
    TArray<UMaterialExpression*> ExpressionsStorage;
    
    if (Material)
    {
        ExpressionsPtr = &Material->GetExpressionCollection().Expressions;
    ...
    {
        ExpressionsPtr = &MaterialFunction->GetExpressionCollection().Expressions;
    ...
    const TArray<UMaterialExpression*>& Expressions = *ExpressionsPtr;
